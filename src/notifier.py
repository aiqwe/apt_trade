...
if __name__ == '__main__':
    ...
    batch_manager(task_id=get_task_id(__file__, last_month, "daily_status"), key=date_id, func=send, if_message=True, text=generate_message(last_month, date_id=date_id))
    batch_manager(task_id=get_task_id(__file__, this_month, "daily_status"), key=date_id, func=send, if_message=True, text=generate_message(this_month, date_id=date_id))